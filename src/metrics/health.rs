        ...
        for file in &core_files {
            ...
            let version_correct = if exists {
                fs::read_to_string(&file_path)
                    .map(|content| content.contains("4.0.0") || content.contains("v4"))
                    .unwrap_or(false)
            } else {
                false
            };
            ...
            components.insert(
                ...
                ComponentHealth {
                    exists,
                    version: if version_correct { "4.0.0".to_string() } else { "unknown".to_string() },
...
mod tests {
    ...
    fn test_get_health() {
        ...
        assert_eq!(report.version, "4.0.0");
    }
    ...
    fn test_get_innovation_metrics() {
        ...
        assert_eq!(metrics.version, "4.0.0");
    }
